...
4 | 'children' | NO | `array` of objects | An array of objects, where each object follows the 'tag', 'attributes', 'text', and 'children' Settings Properties found in this table! (It's a recursive method under the hood!)
